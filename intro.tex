...
\begin{frame}[fragile]
  ...
  \pause \pause \pause
  \begin{center}
  \verb+https://github.com/abelsiqueira/dfopt+
  \end{center}
\end{frame}
...
\begin{frame}[fragile]
  \verb+https://github.com/abelsiqueira/introduction-to-performance-profile+
  \pgfdeclareimage[width=0.1\textwidth]{cc}{cc.large}
  \pgfdeclareimage[width=0.1\textwidth]{by}{by.large}
  \pgfdeclareimage[width=0.1\textwidth]{sa}{sa.large}
  \begin{center}
    \pgfuseimage{cc} 
    \hspace{0.5cm}
    \pgfuseimage{by}
